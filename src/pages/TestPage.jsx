  ...
  return (
    <div className="container mx-auto mt-8">
      ...
      <div className="flex bg-gray-200" style={{ borderRadius: '8px' }}>
        ...
        <button className={`flex-1 py-2 px-4 border-b-2 ${activeTab === 4 ? "border-blue-500 text-blue-500 bg-blue-100" : "border-gray-300 text-gray-500"} focus:outline-none`} onClick={() => handleTabClick(4)}>Starting a Local Chain</button>
      </div>
      ...
      <div className="tab-content mt-4">
        ...
        {activeTab === 4 && <SlidesFromMarkdown markdownUrl="https://raw.githubusercontent.com/Agoric/documentation/kbennett2000-patch-1/main/guides/getting-started/Explainer%20-%20How%20to%20Start%20a%20Local%20Chain.md" />}
      </div>
    </div>
  );
};
